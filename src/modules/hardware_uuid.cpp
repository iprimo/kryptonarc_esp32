...
DEVICE_HARDWARE_INFO getMacAddress() {
    ...
    std::sprintf(strChipRevision, "%d", ESP.getChipRevision());
	HardwareID.sChipRevision = strChipRevision;
	////////////////////////////////////////////////////////////////////////////////

	////////////////////////////////////////////////////////////////////////////////
	// Chip Cores
	char strChipCores[Max_Digits + sizeof(char)];
    std::sprintf(strChipCores, "%d", ESP.getChipCores());
	HardwareID.sChipCores = strChipCores;
	////////////////////////////////////////////////////////////////////////////////

	////////////////////////////////////////////////////////////////////////////////
	// Chip ID
	char strChipID[Max_Digits + sizeof(char)];
    std::sprintf(strChipID, "%d", chipId );
	HardwareID.sChipId = strChipID;
	////////////////////////////////////////////////////////////////////////////////
